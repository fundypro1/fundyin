    ...
    <div class="login-container">
        ...
        <div class="brand-content">
          ...
          <div class="feature-list">
            <div class="feature-item">
              ...
              <div>
                <h3>Secure Access</h3>
                <p>Enterprise-grade security for user operations</p>
              </div>
            </div>
            ...
            <div class="feature-item">
              ...
              <div>
                <h3>Real-time</h3>
                <p>Mining,transactions instantly</p>
              </div>
            </div>
            ...
            <div class="feature-item">
              ...
              <div>
                <h3>Dashboard</h3>
                <p>Earnings,transactins and investment</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="form-section">
        <div class="form-container">
          ...
          <small>Already have an account? <router-link to="/register" class="link">Sign up</router-link></small>
...
export default {
  ...
  mounted() {
    ...
    if (AuthService.isAdminAuthenticated()) {
      const redirectPath = this.$route.query.redirect || '/deposit'
      this.$router.push(redirectPath)
      return
    }

    // Load remembered username
    const rememberedAdmin = localStorage.getItem('remember_user')
    if (rememberedAdmin) {
